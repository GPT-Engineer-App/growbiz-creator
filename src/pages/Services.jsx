...
import webDevImage from "../../public/images/new-web-development-v16.jpg";
      ...
      <VStack spacing={8}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1.5 }}>
          <Box textAlign="center">
            ...
            <Image src={webDevImage} alt="New Website Development v16" borderRadius="md" mb={4} />
            <Text fontSize="lg" fontFamily="Arial, sans-serif" color="gray.600" mb={2}>
              - Online Store Creation
            </Text>
            <Image src={onlineStoreImage} alt="New Online Store Creation v2" borderRadius="md" />
          </Box>
        </motion.div>
      </VStack>
    </Container>
